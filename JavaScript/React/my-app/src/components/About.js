...
export default function About() {
    ...
    } // For setting bright mode

    let toggleMode = () => {

        if(myStyle.color == 'black'){
            setMyStyle(darkMode);
            setButtonText('Enable Bright Mode');
        }
    ...
    } // For togglling between dark and bright modes
  ...
  return (
    <div className='container' style={myStyle}>
        ...
        <div className="container my-3">
            <button type="button" className="btn btn-primary" onClick={toggleMode} >{buttonText}</button>
        </div>
